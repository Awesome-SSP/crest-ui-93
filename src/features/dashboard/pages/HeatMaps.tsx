// HeatMaps.tsx
// ----------------
// Interactive choropleth map of US states demonstrating both a static
// snapshot and a timeline-enabled map. This file uses `react-simple-maps`
// and `d3-scale` to color states based on demo data.
//
// Notes:
// - Uses a public topojson (`us-atlas`) for state boundaries.
// - Includes a simple play/pause timeline to animate monthly data.
...
const HeatMaps = () => {
  ...
  // TODO: Replace with a server-provided dataset or fetch from an API and
  // normalize to the state postal codes used in the topojson.
  const stateData = {
